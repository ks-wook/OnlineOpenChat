...
import com.example.chat.redis.publisher.NotificationRedisPublisher;
...
public class ChatServiceImpl implements ChatService {
    ...
    public CreateRoomResponse createRoom(String authString, CreateRoomRequest request) {
        ...
        try {
            ...
            WebSocketTextMessage notification = WebSocketTextMessage.builder()
                    .type(WebSocketTextMessageType.INVITE)
    ...
    public JoinedRoomListResponse getJoinedRoomsByUserId(String authString) {
        try {
            ...
            List<RoomDto> roomDtoList = findRoomsByUserId(userId);
