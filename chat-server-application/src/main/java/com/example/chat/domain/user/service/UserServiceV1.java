...
import com.example.chat.domain.user.model.Friend;
import com.example.chat.domain.user.model.FriendDto;
...
import com.example.chat.domain.user.repository.FriendRepository;
